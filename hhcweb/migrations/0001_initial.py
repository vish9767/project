    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', django_enumfield.db.fields.EnumField(enum=hhcweb.models.desk_type_enum)),
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.status_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Treatmet_Type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.Treatmet_Type_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Patient_location', django_enumfield.db.fields.EnumField(enum=hhcweb.models.patient_bed_location_enum)),
                ('Facility_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.Facility_type_enum)),
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.is_delet_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', django_enumfield.db.fields.EnumField(enum=hhcweb.models.is_delet_enum)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', django_enumfield.db.fields.EnumField(enum=hhcweb.models.yes_no_enum)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', django_enumfield.db.fields.EnumField(enum=hhcweb.models.consumable_type_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.content_type_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_date', models.DateTimeField(null=True)),
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.active_inactive_enum)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_date', models.DateField(null=True)),
                ('emp_id', models.BigIntegerField(null=True)),
                ('last_modified_by', django_enumfield.db.fields.EnumField(enum=hhcweb.models.last_modified_by_enum)),
                ('last_modified_date', models.DateField(null=True)),
                ('Session_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.Session_status_enum)),
                ('session_note', models.CharField(max_length=200, null=True)),
                ('Reason_for_no_serivce', django_enumfield.db.fields.EnumField(enum=hhcweb.models.Reason_for_no_serivce_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.type_enum)),
                ...
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.consultant_status_enum)),
                ('added_by', models.IntegerField(null=True)),
                ('added_date', models.DateTimeField(null=True)),
                ('last_modified_by', models.IntegerField(blank=True, null=True)),
                ('last_modified_date', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Added_date', models.DateTimeField(null=True)),
                ('isManadatory', django_enumfield.db.fields.EnumField(enum=hhcweb.models.truefalse_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follow_up_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.status_enum)),
                ('follow_up_next_date', models.DateField(blank=True, null=True)),
                ('added_by', models.IntegerField(null=True)),
                ('added_date', models.DateTimeField(null=True)),
                ('last_modified_by', models.IntegerField(blank=True, null=True)),
                ('last_modified_date', models.DateTimeField(blank=True, null=True)),
                ('is_read_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.is_delet_enum)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', django_enumfield.db.fields.EnumField(enum=hhcweb.models.types_enum)),
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.status_enum)),
                ('added_by', models.BigIntegerField(null=True)),
                ('added_date', models.DateField(null=True)),
                ('last_modified_by', models.BigIntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', django_enumfield.db.fields.EnumField(enum=hhcweb.models.types_enum)),
                ('report_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.reporting_by_enum)),
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.status_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eve_poc_id', models.BigIntegerField(null=True)),
                ('srv_id', models.BigIntegerField(null=True)),
                ('service_closed', django_enumfield.db.fields.EnumField(enum=hhcweb.models.yes_no_enum)),
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.status_enum)),
                ('added_by', models.BigIntegerField(null=True)),
                ('added_date', models.DateField(null=True)),
                ('modified_by', models.BigIntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('eve_req_id', models.AutoField(primary_key=True, serialize=False)),
                ('eve_id', models.BigIntegerField(null=True)),
                ('srv_id', models.BigIntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enquiry_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.enquiry_status_enum)),
                ...
                ('discount_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.discount_type_enum)),
                ...
                ('estimate_cost', django_enumfield.db.fields.EnumField(enum=hhcweb.models.estimate_cost_enum)),
                ('isArchive', django_enumfield.db.fields.EnumField(enum=hhcweb.models.yes_no_enum)),
                ('isConvertedService', django_enumfield.db.fields.EnumField(enum=hhcweb.models.yes_no_enum)),
                ('isDelStatus', models.BigIntegerField(null=True)),
                ('added_by', models.BigIntegerField(null=True)),
                ...
                ('Payment_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.Payment_type_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('OTP', models.CharField(max_length=11, null=True)),
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.srv_status_enum)),
                ('added_date', models.DateField(null=True)),
                ('OTP_count', models.IntegerField(null=True)),
                ('otp_expire_time', models.DateField(null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.user_type_enum)),
                ('service_date', models.DateField(null=True)),
                ('added_by', models.BigIntegerField(null=True)),
                ('added_date', models.DateField(null=True)),
                ('modified_by', models.BigIntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.option_type_enum)),
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.status_enum)),
                ('isDelStatus', models.BigIntegerField(null=True)),
                ('added_by', models.BigIntegerField(null=True)),
                ('added_date', models.DateField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('srv_prof_id', models.BigIntegerField(null=True)),
                ('srv_id', models.BigIntegerField(null=True)),
                ('service_render', django_enumfield.db.fields.EnumField(enum=hhcweb.models.yes_no_enum)),
                ('service_date', models.DateField(null=True)),
                ...
                ('skin_perfusion', django_enumfield.db.fields.EnumField(enum=hhcweb.models.skin_perfusion_enum)),
                ('airway', django_enumfield.db.fields.EnumField(enum=hhcweb.models.airway_enum)),
                ('breathing', django_enumfield.db.fields.EnumField(enum=hhcweb.models.breathing_enum)),
                ('circulation', django_enumfield.db.fields.EnumField(enum=hhcweb.models.circulation_enum)),
                ('baseline', django_enumfield.db.fields.EnumField(enum=hhcweb.models.baseline_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consumption_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.consumption_type_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_by', models.BigIntegerField(null=True)),
                ('added_by_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.reg_source_enum)),
                ('added_date', models.DateField(null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Role_id', django_enumfield.db.fields.EnumField(enum=hhcweb.models.Role_id_enum)),
                ('srv_prof_id', models.BigIntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_by_professional', django_enumfield.db.fields.EnumField(enum=hhcweb.models.event_by_professional_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.status_enum)),
                ('isDelStatus', models.BigIntegerField(null=True)),
                ('isVIP', django_enumfield.db.fields.EnumField(enum=hhcweb.models.yes_no_enum)),
                ('added_by', models.BigIntegerField(null=True)),
                ('added_date', models.DateField(null=True)),
                ('last_modified_by', models.BigIntegerField(null=True)),
                ('last_modified_date', models.DateField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=2, null=True)),
                ('added_date', models.DateField(null=True)),
                ('enquiry_from', django_enumfield.db.fields.EnumField(enum=hhcweb.models.enquiry_from_enum)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_by', models.IntegerField(null=True)),
                ('Add_through', django_enumfield.db.fields.EnumField(enum=hhcweb.models.Add_through_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.status_enum)),
                ('payment_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.payment_status_enum)),
                ('Payment_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.Payment_type_enum)),
                ('Payment_mode', django_enumfield.db.fields.EnumField(enum=hhcweb.models.Payment_mode_enum)),
                ('OTP_verifivation', django_enumfield.db.fields.EnumField(enum=hhcweb.models.OTP_verifivation_enum)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.documents_enum)),
                ('isVerified', django_enumfield.db.fields.EnumField(enum=hhcweb.models.truefalse_enum)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Acknowledged', django_enumfield.db.fields.EnumField(enum=hhcweb.models.prof_enum)),
                ('added_date', models.DateTimeField(null=True)),
                ('added_by', models.IntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_night_shift', django_enumfield.db.fields.EnumField(enum=hhcweb.models.yes_no_enum)),
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.status_enum)),
                ('added_by', models.BigIntegerField(null=True)),
                ('added_date', models.DateField(null=True)),
                ('modified_by', models.BigIntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('srv_id', models.BigIntegerField(null=True)),
                ('sub_srv_id', models.BigIntegerField(null=True)),
                ('professional_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.professional_type_enum)),
                ('srv_prof_id', models.BigIntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Note', models.CharField(max_length=50, null=True)),
                ('date', models.DateTimeField(null=True)),
                ('Leave_Conflit', django_enumfield.db.fields.EnumField(enum=hhcweb.models.Leave_Conflit_enum)),
                ('Leave_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.Leave_Conflit_enum)),
                ('rejection_reason', models.CharField(max_length=200, null=True)),
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.truefalse_enum)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professional_id', models.BigIntegerField(null=True)),
                ('professional_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.professional_types_enum)),
                ...
                ('professional_acceptance_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.acceptance_status_enum)),
                ('professional_acceptance_narration', models.CharField(max_length=255, null=True)),
                ('patient_acceptance_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.acceptance_status_enum)),
                ('patient_acceptance_narration', models.CharField(max_length=255, null=True)),
                ('added_user_id', models.BigIntegerField(null=True)),
                ('added_user_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.user_types_enum)),
                ('added_date', models.DateField(null=True)),
                ('modified_user_id', models.BigIntegerField(null=True)),
                ('modified_user_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.user_types_enum)),
                ('modified_date', models.DateField(null=True)),
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.status_enum)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pt_gender', django_enumfield.db.fields.EnumField(enum=hhcweb.models.pt_gender_enum)),
                ...
                ('pt_consultant', django_enumfield.db.fields.EnumField(enum=hhcweb.models.yes_no_enum)),
                ...
                ('reg_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.reg_status_enum)),
                ('added_date', models.DateField(null=True)),
                ('last_modified_date', models.DateField(null=True)),
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.status_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.reference_type_enum)),
                ...
                ('set_location', django_enumfield.db.fields.EnumField(enum=hhcweb.models.set_location_enum)),
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.status_enum)),
                ('isDelStatus', models.BigIntegerField(null=True)),
                ('added_by', models.BigIntegerField(null=True)),
                ('added_date', models.DateField(null=True)),
                ...
                ('document_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.document_status_enum)),
                ...
                ('OTP_verification', django_enumfield.db.fields.EnumField(enum=hhcweb.models.yes_no_enum)),
                ('reg_source', django_enumfield.db.fields.EnumField(enum=hhcweb.models.reg_source_enum)),
                ('availability_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.yes_no_enum)),
                ('location_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.yes_no_enum)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_hd_access', django_enumfield.db.fields.EnumField(enum=hhcweb.models.yes_no_enum)),
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.status_enum)),
                ('added_by', models.BigIntegerField(null=True)),
                ('added_date', models.DateField(null=True)),
                ('last_modified_by', models.BigIntegerField(null=True)),
                ('last_modified_date', models.DateField(null=True)),
                ('flag', django_enumfield.db.fields.EnumField(enum=hhcweb.models.flag_enum)),
                ('Package_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.Package_status_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.session_status_enum)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver', django_enumfield.db.fields.EnumField(enum=hhcweb.models.reciver_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.user_admin_enum)),
                ('module_name', models.CharField(max_length=255, null=True)),
                ('activity_description', models.CharField(max_length=500, null=True)),
                ('added_by_type', django_enumfield.db.fields.EnumField(enum=hhcweb.models.added_by_type_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode_status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.Pause_Ready_enum)),
                ('date_time', models.DateField(null=True)),
                ('is_deleted', django_enumfield.db.fields.EnumField(enum=hhcweb.models.is_delet_enum)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', django_enumfield.db.fields.EnumField(enum=hhcweb.models.pic_enum)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', django_enumfield.db.fields.EnumField(enum=hhcweb.models.employee_type_enum)),
                ('first_name', models.CharField(max_length=50, null=True)),
                ('last_name', models.CharField(max_length=50, null=True)),
                ('middle_name', models.CharField(max_length=50, null=True)),
                ...
                ('status', django_enumfield.db.fields.EnumField(enum=hhcweb.models.status_enum)),
                ('is_login', django_enumfield.db.fields.EnumField(enum=hhcweb.models.is_delet_enum)),
                ('isDelStatus', models.IntegerField(null=True)),
                ('added_by', models.IntegerField(null=True)),
                ('added_date', models.DateTimeField(null=True)),
                ('last_modified_by', models.IntegerField(blank=True, null=True)),

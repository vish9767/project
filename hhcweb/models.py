...
class agg_hhc_patinet_list_enquiry(models.Model):#1
	...
	patient_gender = models.CharField(max_length=7,null=True)
	...
	enquiry_from = enum.EnumField(enquiry_from_enum)
...
class agg_hhc_assessment_patient(models.Model):#2
	...
	# TreatmentType = enum.EnumField(TreatmentType_enum)
...
class agg_hhc_assessment_patient_list(models.Model):#4
	...
	Treatmet_Type = enum.EnumField(Treatmet_Type_enum)
...
class agg_hhc_patients(models.Model):#6
	...
	isVIP = enum.EnumField(yes_no_enum)
...
class agg_hhc_detailed_event_plan_of_care(models.Model):#8
	...
	added_date = models.DateField(null=True)
	emp_id = models.BigIntegerField(null=True)
	last_modified_by = enum.EnumField(last_modified_by_enum)
	last_modified_date = models.DateField(null=True)
	Session_status = enum.EnumField(Session_status_enum)
	session_note = models.CharField(max_length=200,null=True)
	Reason_for_no_serivce = enum.EnumField(Reason_for_no_serivce_enum)
...
class agg_hhc_events(models.Model):#9
	...
	enquiry_status = enum.EnumField(enquiry_status_enum)
	...
	discount_type = enum.EnumField(discount_type_enum)
	...
	# event_status = enum.EnumField(event_status_enum)
	estimate_cost = enum.EnumField(estimate_cost_enum)
	isArchive = enum.EnumField(yes_no_enum)
	isConvertedService = enum.EnumField(yes_no_enum)
	isDelStatus = models.BigIntegerField(null=True)
	added_by = models.BigIntegerField(null=True)
	# Added_through = enum.EnumField(Added_through_enum)
	...
	Payment_type = enum.EnumField(Payment_type_enum)
...
class agg_hhc_event_doctor_mapping(models.Model):#11
	...
	types = enum.EnumField(types_enum)
	status = enum.EnumField(status_enum)
	added_by = models.BigIntegerField(null=True)
	added_date = models.DateField(null=True)
	last_modified_by = models.BigIntegerField(null=True)
...
class agg_hhc_event_job_summary(models.Model):#13
	...
	types = enum.EnumField(types_enum)
	report_status = enum.EnumField(reporting_by_enum)
	status = enum.EnumField(status_enum)
	isDelStatus = models.BigIntegerField(null=True)
	added_by = models.BigIntegerField(null=True)
	added_date = models.DateField(null=True)
...
class agg_hhc_event_professional(models.Model):#16
	...
	eve_poc_id = models.BigIntegerField(null=True)
	srv_id = models.BigIntegerField(null=True)
	service_closed = enum.EnumField(yes_no_enum)
	status = enum.EnumField(status_enum)
	added_by = models.BigIntegerField(null=True)
	added_date = models.DateField(null=True)
	modified_by = models.BigIntegerField(null=True)
...
class agg_hhc_log_for_event(models.Model):#19
	...
	Role_id = enum.EnumField(Role_id_enum)
	srv_prof_id = models.BigIntegerField(null=True)
...
class agg_hhc_sp_incoming_call(models.Model):#23
	...
	# cl_status = enum.EnumField(cl_status_enum)
	is_deleted = enum.EnumField(yes_no_enum)
...
class agg_hhc_extend_service(models.Model):#26
	...
	OTP = models.CharField(max_length=11,null=True)
	status = enum.EnumField(srv_status_enum)
	added_date = models.DateField(null=True)
	OTP_count = models.IntegerField(null=True)
	otp_expire_time = models.DateField(null=True)
...
class agg_hhc_professional_services(models.Model):#28
	...
	srv_id = models.BigIntegerField(null=True)
	sub_srv_id = models.BigIntegerField(null=True)
	professional_type = enum.EnumField(professional_type_enum)
	srv_prof_id = models.BigIntegerField(null=True)
	srv_prof_id = models.BigIntegerField(null=True)
...
class agg_hhc_services(models.Model):#30
	...
	is_hd_access = enum.EnumField(yes_no_enum)
	status = enum.EnumField(status_enum)
	added_by = models.BigIntegerField(null=True)
	added_date = models.DateField(null=True)
	last_modified_by = models.BigIntegerField(null=True)
	last_modified_date = models.DateField(null=True)
	# flag = enum.EnumField(flag_enum)
	package_status = enum.EnumField(package_status_enum)
...
class agg_hhc_service_membership_registration(models.Model):#31
	...
	pt_gender = enum.EnumField(pt_gender_enum)
	...
	pt_consultant = enum.EnumField(yes_no_enum)
	...
	reg_status = enum.EnumField(reg_status_enum)
	added_date = models.DateField(null=True)
	last_modified_date = models.DateField(null=True)
	status = enum.EnumField(status_enum)
	# membership_approval = enum.EnumField(membership_approval_enum)
	membership_note = models.CharField(max_length=100,null=True)
	# membership = enum.EnumField(membership_enum)
...
class agg_hhc_service_professionals(models.Model):#32
	...
	reference_type = enum.EnumField(reference_type_enum)
	...
	loc_id = models.CharField(max_length=240,null=True)
	set_location = enum.EnumField(set_location_enum)
	status = enum.EnumField(status_enum)
	isDelStatus = models.BigIntegerField(null=True)
	added_by = models.BigIntegerField(null=True)
	added_date = models.DateField(null=True)
	...
	document_status = enum.EnumField(document_status_enum)
	...
	OTP_verification = enum.EnumField(yes_no_enum)
	reg_source = enum.EnumField(reg_source_enum)
	availability_status = enum.EnumField(yes_no_enum)
	location_status = enum.EnumField(yes_no_enum)
...
class agg_hhc_jobclosure_detail_datewise(models.Model):#35
	...
	added_by = models.BigIntegerField(null=True)
	added_by_type = enum.EnumField(reg_source_enum)
	# status = enum.EnumField(status_enum)
	added_date = models.DateField(null=True)
...
class agg_hhc_job_closure(models.Model):#37
	...
	srv_prof_id = models.BigIntegerField(null=True)
	srv_id = models.BigIntegerField(null=True)
	service_render = enum.EnumField(yes_no_enum)
	service_date = models.DateField(null=True)
	...
	skin_perfusion = enum.EnumField(skin_perfusion_enum)
	airway = enum.EnumField(airway_enum)
	breathing = enum.EnumField(breathing_enum)
	circulation = enum.EnumField(circulation_enum)
	baseline = enum.EnumField(baseline_enum)
...
class agg_hhc_job_closure_consumption_mapping(models.Model):#38
	...
	consumption_type = enum.EnumField(consumption_type_enum)
...
class agg_hhc_feedback_answers(models.Model):#40
	...
	user_type = enum.EnumField(user_type_enum)
	service_date = models.DateField(null=True)
	added_by = models.BigIntegerField(null=True)
	added_date = models.DateField(null=True)
	modified_by = models.BigIntegerField(null=True)
...
class agg_hhc_feedback_form(models.Model):#41
	...
	option_type = enum.EnumField(option_type_enum)
	status = enum.EnumField(status_enum)
	isDelStatus = models.BigIntegerField(null=True)
	added_by = models.BigIntegerField(null=True)
	added_date = models.DateField(null=True)
...
class agg_hhc_professional_scheduled(models.Model):#46
	...
	is_night_shift = enum.EnumField(yes_no_enum)
	status = enum.EnumField(status_enum)
	added_by = models.BigIntegerField(null=True)
	added_date = models.DateField(null=True)
	modified_by = models.BigIntegerField(null=True)
...
class agg_hhc_reschedule_session(models.Model):#47
	...
	professional_id = models.BigIntegerField(null=True)
	professional_type = enum.EnumField(professional_types_enum)
...
class agg_hhc_payments_received_by_professional(models.Model):#48
	...
	status = enum.EnumField(status_enum)
	payment_status = enum.EnumField(payment_status_enum)
	Payment_type = enum.EnumField(Payment_type_enum)
	Payment_mode = enum.EnumField(Payment_mode_enum)
	OTP_verifivation = enum.EnumField(OTP_verifivation_enum)
...
class agg_hhc_professional_availability_detail(models.Model):#50
    ...
    #professional_location_id=models.ForeignKey(agg_hhc_professional_location,on_delete=models.CASCADE,null=True)
...
class agg_hhc_professional_documents(models.Model):#52
    ...
    status=enum.EnumField(documents_enum)
    isVerified=enum.EnumField(truefalse_enum)
...
class agg_hhc_professional_notification(models.Model):#57
    ...
    Acknowledged=enum.EnumField(prof_enum)
    added_date=models.DateTimeField(null=True)
    added_by=models.IntegerField(null=True)
...
class agg_hhc_professional_weekoff(models.Model):#59
    ...
    Leave_Conflit=enum.EnumField(Leave_Conflit_enum)
    Leave_status=enum.EnumField(Leave_Conflit_enum)
    rejection_reason=models.CharField(max_length=200,null=True)
    status=enum.EnumField(truefalse_enum)
...
class agg_hhc_admin_users(models.Model):#60
    ...
    types=enum.EnumField(desk_type_enum)
    status=enum.EnumField(status_enum)
...
class agg_hhc_assisted_living_booking(models.Model):#63
    ...
    Patient_location=enum.EnumField(patient_bed_location_enum)
    Facility_type=enum.EnumField(Facility_type_enum)
    #agg_sp_pt_id=models.ForeignKey(agg_hhc_patients,on_delete=models.CASCADE,null=True)
    status=enum.EnumField(is_delet_enum)
    date=models.DateTimeField(null=True)
...
class agg_hhc_avaya_extensions(models.Model):#65
    ...
    is_deleted=enum.EnumField(is_delet_enum)
...
class agg_hhc_consumables(models.Model):#72
    ...
    name=models.CharField(max_length=255,null=True)
    types=enum.EnumField(consumable_type_enum)
...
class agg_hhc_content(models.Model):#73
    ...
    #hosp_id=models.ForeignKey(agg_hhc_hospitals,on_delete=models.CASCADE,null=True)
    content_type=enum.EnumField(content_type_enum)
...
class agg_hhc_doctors_consultants(models.Model):#76
    ...
    status=enum.EnumField(consultant_status_enum)
    #isDelStatus=models.IntegerField(null=True)
    added_by=models.IntegerField(null=True)
    added_date=models.DateTimeField(null=True)
    last_modified_by=models.IntegerField(null=True,blank=True)
...
class agg_hhc_documetns_list(models.Model):#77
    ...
    Added_date=models.DateTimeField(null=True)
    isManadatory=enum.EnumField(truefalse_enum)
...
class agg_hhc_employees(models.Model):#79
    ...
    types=enum.EnumField(employee_type_enum)
    ...
    is_login=enum.EnumField(is_delet_enum)
    isDelStatus=models.IntegerField(null=True)
    added_by=models.IntegerField(null=True)
    added_date=models.DateTimeField(null=True)
    last_modified_by=models.IntegerField(null=True,blank=True)
...
class agg_hhc_enquiry_follow_up(models.Model):#81
    ...
    follow_up_status=enum.EnumField(status_enum)
    follow_up_next_date=models.DateField(null=True,blank=True)
    added_by=models.IntegerField(null=True)
    added_date=models.DateTimeField(null=True)
    last_modified_by=models.IntegerField(null=True,blank=True)
    last_modified_date=models.DateTimeField(null=True,blank=True)
    is_read_status=enum.EnumField(is_delet_enum)
...
class agg_hhc_log_location_for_session(models.Model):#87
    ...
    event_by_professional=enum.EnumField(event_by_professional_enum)
    #professional_id=models.ForeignKey(agg_hhc_service_professionals,on_delete=models.CASCADE,null=True)
...
class agg_hhc_payments(models.Model):#93
    ...
    types=models.CharField(max_length=50,null=True)
    added_by=models.IntegerField(null=True)
    Add_through=enum.EnumField(Add_through_enum)
    Card_Number=models.BigIntegerField(null=True)
    Transaction_ID=models.CharField(max_length=11,null=True)
...
class sp_ready_pause_history(models.Model):#97
    ...
    mode_status=enum.EnumField(Pause_Ready_enum)
    date_time=models.DateField(null=True)
    is_deleted=enum.EnumField(is_delet_enum)
...
class agg_hhc_session(models.Model):#99
    ...
    status=enum.EnumField(session_status_enum)
...
class agg_hhc_teleconsultation_enquiry(models.Model):#104
    ...
    receiver=enum.EnumField(reciver_enum)
...
class agg_hhc_user_activity(models.Model):#105
    ...
    module_type=enum.EnumField(user_admin_enum)
    #module_id=models.ForeignKey(agg_hhc_modules,on_delete=models.CASCADE,null=True)
    module_name=models.CharField(max_length=255,null=True)
    ...
    added_by_type=enum.EnumField(added_by_type_enum)
